...
export default function AuthorAdminDashboard() {
  ...
  // Chart functions from StatsSection
  const getPaginatedArticles = () => {
    const startIndex = (currentChartPage - 1) * ARTICLES_PER_CHART_PAGE;
    const endIndex = startIndex + ARTICLES_PER_CHART_PAGE;
    return prepareViewsData().slice(startIndex, endIndex);
  };

  const totalChartPages = Math.ceil(prepareViewsData().length / ARTICLES_PER_CHART_PAGE);
            ...
            {isAuthenticated && author && !loading && !error && (
              <>
                ...
                {activeSection === "articles" && (
                  <>
                    {/* STATS SECTION COMBINED WITH ARTICLES - INCLUDING BAR CHARTS */}
                    <motion.section
                      key="stats"
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="bg-white/95 dark:bg-[#000000] backdrop-blur-sm rounded-2xl md:rounded-3xl border border-gray-200 dark:border-gray-700 shadow-2xl overflow-hidden mb-12 md:mb-16"
                    >
                      {/* Header */}
                      ...
                      <div className="p-4 md:p-8">
                        ...
                        <div className="mb-8 md:mb-12">
                          ...
                          {loadingCharts ? (
                          ...
                          ) : !chartsLoaded || prepareViewsData().length === 0 ? (
                            <div className="text-center py-20">
                            ...
                            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-6 md:p-8">
                              <div className="flex items-center justify-between mb-6">
                                ...
                                {prepareViewsData().length > ARTICLES_PER_CHART_PAGE && (
                                  ...
                                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                    ...
                                    <div className="text-right">
                                      ...
                                      <p className="text-3xl md:text-3xl text-black dark:text-white">
                                        {formatNumber(prepareViewsData()[0].read_count)}
                                      </p>
                                    </div>
                                  </div>
                                </div>
                    ...
                    >
                      ...
                      {/* MOBILE OPTIMIZED PAGINATION - MUST BE INSIDE THE SAME SECTION */}
                      {totalPages > 1 && (
