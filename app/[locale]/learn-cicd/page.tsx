...
export default function CICDEssentialsSeries() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Fetch articles with cicd-series tag
        const articlesRes = await fetch(
          `${API_BASE_URL}/articles/?tags__slug=cicd-series&ordering=published_at`
        );
        ...
        setError(err.message || "Failed to fetch CI/CD Series data");
        setLoading(false);
      }
    }
    fetchData();
  ...
  const getCleanExcerpt = (article: Article) => {
    ...
    if (article.content) {
      ...
      return (
        ...
        "Explore this CI/CD essentials article to master automation..."
      );
    }

    return "Explore this CI/CD essentials article to master automation...";
  };
      ...
      <div className="min-h-screen bg-white dark:bg-[#000000] transition-colors duration-300">
        ...
        <main className="max-w-6xl mx-auto px-4 py-20">
          <div className="text-center">
            <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-violet-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-2xl font-semibold hover:shadow-2xl transition-all duration-300 hover:scale-105 shadow-lg"
            >
              Return Home
        ...
        <main className="max-w-7xl mx-auto px-4 py-20">
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            <div className="relative">
              <div className="w-32 h-32 rounded-full border-4 border-purple-200/50 dark:border-purple-800/30 animate-spin">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl flex items-center justify-center p-2">
                    <RefreshCw className="w-16 h-16 text-purple-600 dark:text-purple-400 animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          <div className="mb-8 md:mb-12">
            <div className="flex items-center gap-4 mb-4 md:mb-6">
              <div className="h-px w-12 md:w-16 bg-gradient-to-r from-purple-500 to-violet-600"></div>
              <span className="text-xs md:text-sm font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-wide">
                CI/CD Essentials Series
              </span>
            </div>

            <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-8 mb-6 md:mb-8">
              {/* CI/CD Logo with Purple Theme */}
                ...
                <div className="w-20 h-20 md:w-28 md:h-28 rounded-2xl border-4 border-white dark:border-gray-800 shadow-2xl overflow-hidden bg-white p-1">
                  <div className="w-full h-full rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center">
                    <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
                      <RefreshCw className="w-12 h-12 md:w-16 md:h-16 text-purple-600 dark:text-purple-400" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-base md:text-xl text-black dark:text-gray-300 leading-relaxed max-w-3xl">
                  Master Continuous Integration and Deployment from the ground up.
                  A structured series covering pipelines, automation, testing,
                  deployment strategies, and DevOps best practices through
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 max-w-4xl mx-auto md:py-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs md:text-sm font-semibold uppercase tracking-wide text-purple-600 dark:text-purple-400">
                Articles
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs md:text-sm font-semibold uppercase tracking-wide text-violet-600 dark:text-violet-400">
                Total Views
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs md:text-sm font-semibold uppercase tracking-wide text-fuchsia-600 dark:text-fuchsia-400">
                Total Reactions
              </div>
            </div>
          </div>
        ...
        >
          ...
          {articles.length === 0 ? (
            <div className="text-center py-12 md:py-20">
              <div className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-purple-500 to-violet-600 rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-xl">
              ...
              <p className="text-sm md:text-lg text-slate-600 dark:text-gray-400 mb-6 md:mb-8 font-medium max-w-md mx-auto px-4">
                The CI/CD Essentials Series is being prepared. Check back soon
                    ...
                    >
                      <div className="flex flex-col gap-4 md:gap-8 md:flex-row items-start">
                        ...
                        <div className="flex-1 min-w-0 w-full">
                          ...
                          <h3 className="text-lg md:text-2xl font-bold text-slate-800 dark:text-white mb-2 md:mb-3 line-clamp-2 group-hover:text-purple-700 dark:group-hover:text-purple-400 transition-colors">
                          ...
                          {author && (
                            <div className="flex items-center gap-2 md:gap-3 mt-4">
                              <div className="flex items-center gap-1 md:gap-2 text-slate-700 dark:text-gray-300 font-medium">
                                <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 p-0.5">
                                  <img
                                ...
                                <Link
                                  ...
                                  className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors text-xs md:text-sm"
                                >
                                  {author.name}
                                </Link>
                              </div>
                        ...
                        <div className="flex items-center w-full md:w-auto justify-end md:justify-start">
                          <Link
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-lg md:rounded-xl hover:shadow-lg transition-all duration-300 font-semibold shadow-md hover:scale-105 group/btn text-sm md:text-base w-full md:w-auto justify-center"
                          >
                            Read More
