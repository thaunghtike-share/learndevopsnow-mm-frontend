...
export default function GitEssentialsSeries() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Fetch articles with git-series tag
        const articlesRes = await fetch(
          `${API_BASE_URL}/articles/?tags__slug=git-series&ordering=published_at`
        );
        ...
        setError(err.message || "Failed to fetch Git Series data");
        setLoading(false);
      }
    }
    fetchData();
  ...
  const getCleanExcerpt = (article: Article) => {
    ...
    if (article.content) {
      ...
      return (
        ...
        "Explore this Git essentials article to master version control..."
      );
    }

    return "Explore this Git essentials article to master version control...";
  };
              ...
              <div className="w-32 h-32 rounded-full border-4 border-emerald-200/50 dark:border-emerald-800/30 animate-spin">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl flex items-center justify-center p-2">
                    <GitBranch className="w-16 h-16 text-emerald-600 dark:text-emerald-400 animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
        ...
        >
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6 md:gap-8 mb-6 md:mb-8">
                ...
                <div className="w-20 h-20 md:w-28 md:h-28 rounded-2xl border-4 border-white dark:border-gray-800 shadow-2xl overflow-hidden bg-white p-1">
                  <div className="w-full h-full rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center">
                    <div className="w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
                      <GitBranch className="w-12 h-12 md:w-16 md:h-16 text-emerald-600 dark:text-emerald-400" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-base md:text-xl text-black dark:text-gray-300 leading-relaxed max-w-3xl">
                  Master Git version control from the ground up. A structured
                  series covering fundamental commands, branching strategies,
                  collaboration workflows, advanced techniques, and best
                  practices through practical examples and real-world scenarios.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 max-w-4xl mx-auto md:py-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-xs md:text-sm font-semibold uppercase tracking-wide text-lime-600 dark:text-lime-400">
                Total Reactions
              </div>
            </div>
          </div>
          ...
          {articles.length === 0 ? (
            <div className="text-center py-12 md:py-20">
              ...
              <p className="text-sm md:text-lg text-slate-600 dark:text-gray-400 mb-6 md:mb-8 font-medium max-w-md mx-auto px-4">
                The Git Essentials Series is being prepared. Check back soon
                          ...
                          {author && (
                            <div className="flex items-center gap-2 md:gap-3 mt-4">
                              <div className="flex items-center gap-1 md:gap-2 text-slate-700 dark:text-gray-300 font-medium">
                                <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-gradient-to-br from-emerald-500 to-green-600 p-0.5">
                                  <img
                                ...
                                <Link
                                  ...
                                  className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors text-xs md:text-sm"
                                >
                                  {author.name}
                                </Link>
                              </div>
